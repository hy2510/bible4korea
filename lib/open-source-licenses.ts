...
export const DATA_SOURCE_LICENSES: LicenseEntry[] = [
  {
    name: "성경전서 새번역 (RNKSV)",
    description: "로컬 새번역(RNKSV) 한국어 성경 본문",
  ...
  {
    name: "Midvash API",
    description: "로컬 새번역이 없는 권의 개역한글판 성경 본문 및 권·장 메타데이터",
  ...
  {
    name: "개역한글판",
    description: "로컬 새번역이 없는 권의 한국어 성경 번역본",
    license: "대한성서공회 저작권",
  ...
  },
  {
    ...
    description: "원어 분석(히브리어·헬라어) 및 Strong's 사전 데이터 소스",
    license: "Bible SuperSearch API 이용 약관",
    url: "https://www.biblesupersearch.com/",
    note: "원어 분석은 Bible SuperSearch API를 우선 사용하며, 응답이 없을 때 로컬 morphhb/MorphGNT로 대체합니다.",
  },
  {
    name: "OSHB (Open Scriptures Hebrew Bible)",
    description: "구약 히브리어 원문 및 형태소 정보 (Bible SuperSearch 대체용)",
    license: "Creative Commons Attribution 4.0 (CC BY 4.0)",
    url: "https://github.com/openscriptures/morphhb",
  },
  {
    name: "MorphGNT / SBLGNT",
    description: "신약 헬라어 원문 및 형태소 분석 (Bible SuperSearch 대체용)",
